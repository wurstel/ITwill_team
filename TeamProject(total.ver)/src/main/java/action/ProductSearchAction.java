...
public class ProductSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("ProductSearchAction");
		...
		String search = request.getParameter("search"); // 스토어페이지에서 가져온 search 값
		...
		int listCount = service.selectSearchListCount(search);
		...
		articleList = service.selectSearchProductList(pageNum, listLimit, search);
