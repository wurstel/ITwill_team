...
public class CustomerCenterAdminAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("CustomerCenterAction");
		...
		CenterListService service = new CenterListService();
		int listCount = service.getListCount();
				
		// BoardListService 의 getArticleList 메서드를 호출하여 게시물 목록 가져오기
		// 파라미터 : 페이지번호(pageNum), 페이지 당 게시물 수(listLimit) 리턴타입 : ArrayList<BoardDTO>
		...
		forward.setPath("./admin/qnaListManage.jsp");
